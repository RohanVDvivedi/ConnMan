...
PUBLIC_HEADERS:=stream.h server.h client.h client_set.h comm_address.h ssl_ctx_helper.h file_descriptor_stream.h piped_stream.h ssl_stream.h writable_dstring_stream.h stream_util.h zlib_stream_context.h zlib_readable_decompression_stream.h zlib_writable_compression_stream.h
...
LFLAGS:=-L${LIB_DIR} -l${PROJECT_NAME} -lboompar -lpthread -lcutlery -lssl -lcrypto -lz
# Archiver
AR:=ar rcs
