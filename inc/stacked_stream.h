...
stream* get_nth_from_top_of_stacked_stream(stacked_stream* sstrm, int operate_on);

// below function can take only READ_STREAMS, WRITE_STREAMS and BOTH_STREAMS in their operate_on parameter
